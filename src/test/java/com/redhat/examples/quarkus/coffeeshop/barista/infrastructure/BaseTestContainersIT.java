...
public class BaseTestContainersIT {

    static DockerComposeContainer dockerComposeContainer;

    //Kafka stuff
    String INCOMING_TOPIC_NAME = KafkaResource.KafkaTopics.INCOMING;

    String OUTGOING_TOPIC_NAME = KafkaResource.KafkaTopics.OUTGOING;
